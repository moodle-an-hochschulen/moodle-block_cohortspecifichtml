...
class provider implements \core_privacy\local\metadata\provider,
    ...
    /**
     * Returns information about how block_cohortspecifichtml stores its data.
     *
    ...
    public static function get_contexts_for_userid(int $userid) : \core_privacy\local\request\contextlist {
        ...
        $sql = "SELECT c.id
            ...
            INNER JOIN {context} bpc ON bpc.id = b.parentcontextid
                 WHERE b.blockname = 'cohortspecifichtml'
    ...
    public static function export_user_data(approved_contextlist $contextlist) {
        ...
        foreach ($instances as $instance) {
            ...
            $block = block_instance('cohortspecifichtml', $instance);
